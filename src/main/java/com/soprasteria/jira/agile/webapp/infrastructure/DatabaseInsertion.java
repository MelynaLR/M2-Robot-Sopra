...
public class DatabaseInsertion {
    ...
    public static void insertIssueIntoDatabase(Issue issue) {
        ...
        try {
            ...
            String sql = "INSERT INTO issue (idIssue,userName, description, creationDate, sprintEndDate, sprintId, sprintStartDate, Status, project_id, priority, userPoints) VALUES (?,?,?,?,?,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE userPoints = ?";
            ...
            preparedStatement.setString(6, issue.getSprintId());
            ...
            preparedStatement.setInt(12, issue.getUserPoints());
